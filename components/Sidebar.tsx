...
import { LayoutDashboard, Receipt, Sparkles, LogOut, Wallet, Settings, ShieldAlert, Code, Lock, Handshake, Package, Users, CreditCard, UserCog, ShieldCheck, Zap, HelpCircle, ArrowRightLeft, Coins, BrainCircuit, Scan, Terminal, Shield, Activity, Cpu, Database, Crown, User, TrendingUp, BarChart3 } from 'lucide-react';
